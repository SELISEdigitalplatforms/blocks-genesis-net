...
We are committed to providing a welcoming, respectful, and inclusive environment for all contributors and community members of the **blocks-genesis-net** project. As maintainers, contributors, and participants, we pledge to make collaboration within our community a harassment-free, inclusive experience for everyone, regardless of age, body size, disability, ethnicity, gender identity and expression, level of experience, nationality, personal appearance, race, religion, socioeconomic status, sexual identity and orientation, or any other dimension of identity.
...
This Code of Conduct applies to all community spaces associated with the blocks-genesis-net project, including but not limited to:
