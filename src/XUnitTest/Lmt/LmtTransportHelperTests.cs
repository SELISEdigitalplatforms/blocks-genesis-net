...
public class LmtTransportHelperTests
{
    ...
    {
        Assert.True(LmtTransportHelper.IsRabbitMq("amqp://<username>:<password>@localhost:5672"));
    }

    [Fact]
    public void IsRabbitMq_ShouldReturnTrue_ForAmqpsScheme()
    {
        Assert.True(LmtTransportHelper.IsRabbitMq("amqps://<username>:<password>@rabbitmq.example.com:5671"));
    }
